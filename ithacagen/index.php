...
<header id="homehead" class="site-header" role="banner">
      ...
      <div style="width: 50%; padding: 10px; margin-left: auto; margin-right: auto; display: block;">
        ...
        <button style="margin-left: auto; margin-right: auto; display: block; background-color: #8CC640; color: #fc6c85; font-weight: bolder; font-family: 'Outage'; font-size: 75px;" class="givegab-button" data-campaign-id="25038" data-host="https://www.givegab.com" data-org-id="454711">Holiday Giving Campaign</button>
      </div>                
		</nav><!-- #site-navigation -->
