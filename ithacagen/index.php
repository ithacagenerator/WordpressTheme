...
<header id="homehead" class="site-header" role="banner">
      ...
      <div style="width: 50%; padding: 10px; margin-left: auto; margin-right: auto; display: block;">
        ...
        <button style="margin-left: auto; margin-right: auto; display: block;" class="givegab-button" data-campaign-id="25038" data-host="https://www.givegab.com" data-org-id="454711" style="background-color: #8CC640; color: red">Holiday Campaign</button>
      </div>                
		</nav><!-- #site-navigation -->
